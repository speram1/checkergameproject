...
public class Main {
	...
	public static void startGame() throws IOException
	{
		...
		while(true)
		{
			...
			{
				printBoard(board.getBoard());
				System.out.println("player wins !!!"+board.getCapture()); endGame("player");}
			printBoard(board.getBoard());
			board = computerMove(board);
			if(board.getCapture()) 
			{printBoard(board.getBoard());System.out.println("computer wins !!!"+board.getCapture());endGame("computer");}
			printBoard(board.getBoard());
